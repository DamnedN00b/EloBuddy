...
using SharpDX;
using DrawSettings = LazyIllaoi2._0.Config.Modes.Drawings;
using SkinSettings = LazyIllaoi2._0.Config.Modes.Skins;
using ComboSettings = LazyIllaoi2._0.Config.Modes.Combo;
using HarassSettings = LazyIllaoi2._0.Config.Modes.Harass;
using JungleClearSettings = LazyIllaoi2._0.Config.Modes.JungleClear;
using LaneClearSettings = LazyIllaoi2._0.Config.Modes.LaneClear;

// ReSharper disable StringLiteralsWordIsNotInDictionary

namespace LazyIllaoi2._0
{
